...
VALUES(
    ...
    '아보카도 아이크림',
    'https://img.hwahae.co.kr/products/1942105/1942105_20230216173808.jpg?format=webp&size=600x600',
    4.58,
    2290,
    16000,
    15,
   ...
   1187,
    ...
    '픽앤퀵 뽑아쓰는 마스크 [화장발]',
    "https://img.hwahae.co.kr/products/1897092/1897092_20220801000000.jpg?format=webp&size=600x600",
    4.24,
   750,
    23000,
    380,
...
select * from cos;
rename table product to cos_data;
...
select * from cos_data;
alter table cos_data drop brand_img_src;
alter table cos_data add column cos_type varchar(100);

select * from cos_data_skin;
drop table cos_data_skin;
ALTER TABLE cos_data ADD PRIMARY KEY (IDX);
